                              ...
                              <div className="widget-content p-0">
                                  <div className="widget-content-wrapper">
                                      ...
                                      <div className="widget-content-left">
                                          <div className="widget-heading" onClick={()=>{console.log("jk")}}>Fixed Header</div>
                      ...
                      <ul className="list-group">
                          <li className="list-group-item">
                              ...
                              <div className="theme-settings-swatches">
                                  ...
                                  <div className="swatch-holder bg-success switch-header-cs-class" data-class="bg-success header-text-light"></div>
                                  <div className="swatch-holder bg-info switch-header-cs-class" data-class="bg-info header-text-light"></div>
